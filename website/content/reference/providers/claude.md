...
- **App Store build.** Grant `~/.claude` and `~/.claude.json` once; see [folder grants](/start/connect/#folder-grants).
  They hold the profile and the transcripts behind [History](/reference/history/).
