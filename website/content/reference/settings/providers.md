...
App Store build shows resource-grant buttons where needed. **Setup guide** on each provider opens that provider's
[page](/reference/providers/), which lists the credentials the app reads and what macOS asks you to approve.
