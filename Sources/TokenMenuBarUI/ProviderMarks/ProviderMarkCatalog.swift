...
public enum ProviderMarkCatalog {
  ...
  private static func backgroundColor(
    ...
    case (.antigravity, .light): BrandColor(0x2C_3E7A)
    case (.antigravity, .dark): BrandColor(0x1C_2A57)
  ...
  private static func foregroundColor(
    ...
    case (.antigravity, .light): BrandColor(0xE4_EAFF)
    case (.antigravity, .dark): BrandColor(0xFF_FFFF)
